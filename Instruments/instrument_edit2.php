...
<tr BGCOLOR="#99CCFF"><td align="right"><b>Assembly Number: </td>
<td><input type="text" name="Assembly_N" size="20" value="<?=$objResult["Assembly_N"];?>"></br></td>

<td align="right"><b>Checkout:</td>
<td><input type="text" name="checkout" size="20" value="<?=$objResult["checkout"];?>"></br></td></tr>
