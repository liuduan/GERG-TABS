...
<tr BGCOLOR="#99CCFF"><td align="right"><b>File Number: </td><td>	<?php echo $objResult["checkout"];?></td>
<td align="right"><b>old_checkout:</td><td><input type="text" name="old_checkout" size="20" value="<?=$objResult["old_checkout"];?>"></br></td></tr>
...
<tr BGCOLOR="#FFFFCC"><td align="right"><b>Lead Technician: </td><td><input type="text" name="technician" size="20" value="<?=$objResult["technician"];?>"> </td>
</table>
</b>
