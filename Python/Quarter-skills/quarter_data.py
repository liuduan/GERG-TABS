...
The problem with the float point was fixed.
...
v_model = np.zeros(368*6)
for n in range(368):
    t_model[n*6:(n+1)*6] = source_CDF.variables['valid_time'][4,n,0:6]
    u_model[n*6:(n+1)*6] = source_CDF.variables['water_u'][4,n,0:6]
    v_model[n*6:(n+1)*6] = source_CDF.variables['water_v'][4,n,0:6]
print t_model
print v_model
print source_CDF.variables['water_v'][4,3,0:6]

source_CDF.close()

print t_model.shape
print seconds_to_datetime(t_model[0])
...
######################################## The following extract model data and make a big array, and save the array #############
################ Buoy Selection ######################
