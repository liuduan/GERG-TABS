...
if (! file_exists($forecast_img))
	{$forecast_img = 'http://tabs2.gerg.tamu.edu/tglo/testpages/Comparison/forecast_files/'. gmdate("d", time() + $day_adjust*24*3600 - 24*3600). $file_name_part2. ".png";
    }      //end of Checking file existant.
...
if ($Last_Report == 1){
	...
	# echo '<br>'. $row[obs_time];
	echo " hour(s) ago. <br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (". substr($row[obs_time], 0, 16). " UTC)";
	echo '</font>';
	} 		//The end of if
	}}		# end of line searching file name.
...
var icons = ['http://tabs2.gerg.tamu.edu/tglo/testpages/Map-frame-1/icons/buoy.png',
				...
				'http://tabs2.gerg.tamu.edu/tglo/testpages/Map-frame-1/icons/NDBC-buoy.png',
				'http://tabs2.gerg.tamu.edu/tglo/testpages/Map-frame-1/icons/NDBC-buoy.png',
				'http://tabs2.gerg.tamu.edu/tglo/testpages/Map-frame-1/icons/NDBC-buoy.png',
...
function initialize(){
  var newark = new google.maps.LatLng(27.2, -95);
