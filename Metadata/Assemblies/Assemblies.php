...
<form name="form1"  action="./Assemblies_insert.php" onSubmit="return required(document.form1.Assembly_N)" method="get" bgcolor ="red" 
style="display: inline; vertical-align:middle;">	

<table BORDER='0' CELLPADDING=3>
<tr BGCOLOR="#99CCFF" class="HEADING-STYLE"><td align="right" width ="340">What is the New Buoy Assembly Number: </td>
<td>
<input name="Assembly_N">
</td>
</tr>
