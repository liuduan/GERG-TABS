...
import pylab as P
################################## fig 6 is right #############
##########################			fig 4 might be good, but has problem.
#
...
#
P.figure(4)       # 4, This fig is having problems.
...
n, bins, patches = P.hist(x, 10, normed=1, histtype='bar', label=['Crimson', 'Burlywood', 'Chartreuse'])
P.legend()
