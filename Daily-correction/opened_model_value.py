...
def model_value(ff_CDF, Buoy_name, start_point, end_point):
    ...
    t = zeros(number_hours)
    u = zeros(number_hours)
    v = zeros(number_hours)
    ...
    model_u = u
    model_v = v
    # print "model_t.shape, model_u.shape, model_v.shape: ", model_t.shape, model_u.shape, model_v.shape
...
def interpo(buoy_name, time_ele, lon_buoy, lat_buoy, mod_lon_ele, mod_lat_ele):  ### time_ele is for the time points with data.
