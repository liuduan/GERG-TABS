...
<body bgcolor="c0c8d6">
<center><h4 class="Sub_TITLE-STYLE">TABS 2.25 m Buoy Setup and Test Report</h4>
...
<?php
	...
	$strSQL = "SELECT * FROM TABS225m WHERE file_number = '".$_GET["file_number"]."' ";  // <!-- check the data table name -->
	$objQuery = mysql_query($strSQL);
	$objResult = mysql_fetch_array($objQuery);
	if(!$objResult)
	{
		echo "Not found file_number=".$_GET["file_number"];
	}
	else
	{
	?>
...
<form action="./TABS225m.php" name="frmEdit" method="post">
<center>

<table class="table_style">
<tr>
<td BGCOLOR="#99CCFF" align="right"><b>File Number: </td>
<td BGCOLOR="#FFFFCC"><?php echo $objResult["file_number"];?></td>

<td BGCOLOR="#99CCFF" align="right"><b>Checkout: </td>
<td BGCOLOR="#FFFFCC"><?=$objResult["checkout"];?></td>
